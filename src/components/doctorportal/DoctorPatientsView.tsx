    ...
    <div className="space-y-6 text-slate-800 dark:text-slate-100">
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xs flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3 w-full md:w-auto flex-1">
          <div className="relative w-full max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-medium focus:outline-none focus:ring-2 focus:ring-emerald-600"
            />
          </div>
        ...
        <button
          ...
          className="w-full md:w-auto px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold transition-all shadow-sm flex items-center justify-center gap-2 cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 bg-white dark:bg-slate-800 rounded-2xl p-4 border border-slate-200 dark:border-slate-700 shadow-xs space-y-3">
          <h3 className="font-bold text-xs uppercase tracking-wider text-slate-400 px-1 flex items-center gap-2">
            <Users className="w-4 h-4 text-emerald-600" /> Patient Directory
          </h3>
              ...
              return (
                <div
                  ...
                  className={`p-3.5 rounded-xl border text-xs cursor-pointer transition-all space-y-1.5 ${
                    isSelected
                      ? 'bg-emerald-950 text-white border-emerald-600 shadow-md ring-1 ring-emerald-500/50'
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${
                      isSelected ? 'bg-emerald-800 text-emerald-200' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300'
                    }`}>
                      {pat.gender}, {pat.age}y
                    </span>
                  </div>

                  <p className={isSelected ? 'text-emerald-200 text-[11px]' : 'text-slate-500 text-[11px]'}>
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-xs space-y-4">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-700 pb-4">
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="px-2.5 py-1 rounded-full bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs font-bold text-slate-700 dark:text-slate-300">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl bg-indigo-950 text-indigo-300 border border-indigo-800 hover:bg-indigo-900 text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer"
                >
            ...
            <div className="flex border-b border-slate-200 dark:border-slate-700 space-x-4 pt-2">
              <button
